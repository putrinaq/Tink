...
// Use LEFT JOIN so orders show up even if customer is deleted
$join_sql = "FROM `ORDER` o LEFT JOIN CUSTOMER c ON o.CUSTOMER_ID = c.CUSTOMER_ID";
...
<body>
    <aside class="sidebar">
        ...
        <nav>
            <ul>
                <li><a href="/admin/dashboard.php"><i class='bx bxs-dashboard'></i> <span>Dashboard</span></a></li>
                <li><a href="/admin/catalog.php"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                ...
                <li><a href="/admin/customers.php"><i class='bx bxs-user-circle'></i> <span>Customers</span></a></li>
                <li class="active"><a href="#"><i class='bx bxs-shopping-bags'></i> <span>Orders</span></a></li>
                <li><a href="/admin/designers.php"><i class='bx bxs-palette'></i> <span>Designers</span></a></li>
            </ul>
        </nav>
    </aside>
