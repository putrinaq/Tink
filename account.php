...
// 2. Fetch Order History (Carts that are NOT 'active')
// We order by ID DESC to show newest orders first
$order_sql = "SELECT * FROM `order` WHERE CUSTOMER_ID = ? ORDER BY ORDER_DATE DESC";
                    ...
                    <form action="account.php" method="POST" id="profileForm" class="edit-form" style="display:none;">
                        ...
                        <div class="form-group">
                            ...
                            <textarea name="address" rows="4"
                                required><?= htmlspecialchars($user['CUSTOMER_ADDRESS']) ?></textarea>
                        </div>
                ...
                <?php else: ?>
                    <div class="order-list">
                        <?php foreach ($orders as $order):
                            // 1. Get the items linked to this order using the CART_ID stored in the order row
                            ...
                            // 2. Use the Total directly from the database
                        ...
                        ?>
                            ...
                            <div class="order-card">
                                <div class="order-header">
                                    ...
                                    <span class="order-total">RM <?= number_format($order['ORDER_TOTAL'], 2) ?></span>
                                </div>
