    ...
    <div class="product-container">
        ...
        <div class="gallery-wrapper">
            <div class="thumbnails">
                <?php foreach ($gallery_images as $index => $img): $clean_img = ltrim($img, '/');?>
                <img src="<?= htmlspecialchars($clean_img) ?>" class="<?= $index === 0 ? 'active' : '' ?>"
    ...
    <div class="designer-section">
        ...
        <div class="designer-grid">
            ...
            <a href="product_detail.php?id=<?= $related['ITEM_ID'] ?>" class="mini-card">
                <img src="<?= htmlspecialchars(ltrim($related['ITEM_IMAGE'],'/')) ?>" alt="Rel">
